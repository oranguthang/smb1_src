#!/usr/bin/env python3
"""Prepare validated private source assets required by ANN payload builds."""
...
def prepare_assets(
    ...
    payloads = extract_fds_payloads(reference.read_bytes(), profile)
...
def main() -> int:
    ...
    print(f"[OK] Prepared ANN payload source assets: {args.output_dir}")
    return 0
